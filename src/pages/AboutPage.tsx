  ...
  return (
    <div className="min-h-screen pt-24 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-text-main mb-4">About TrustGov</h1>
      ...
      <div className="space-y-16">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-2xl font-bold text-text-main mb-4">What is TrustGov?</h2>
          ...
          <div className="glass p-8 rounded-2xl flex items-center justify-center">
            <Shield className="w-32 h-32 text-brand opacity-20 absolute" />
            <Shield className="w-24 h-24 text-brand relative z-10" />
          </div>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-text-main mb-8 text-center">Our Mission</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-sm text-text-muted">Simplifying the digital experience for every citizen.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-brand/10 rounded-xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-text-muted">Implementing the highest standards of cybersecurity.</p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-sm text-text-muted">Ensuring government records are immutable and transparent.</p>
            </div>
          </div>
        </section>

        <section className="glass p-8 rounded-3xl border border-white/10">
          <h2 className="text-2xl font-bold text-text-main mb-4">Hackathon Prototype</h2>
          ...
          <div className="flex items-center space-x-4 text-sm font-mono text-brand">
